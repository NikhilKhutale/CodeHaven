...
import { monthlySales, ysearlySales, monthlyRevenue, yearlyRevenue } from '../data';
...
const AdminSalesRevenuChart = () => {
    ...
    return (
        <div className='text-center'>
            ...
            {chartData && chartData.datasets && chartData.labels && <Line options={chartOptions} data={chartData} />}
        </div>
    )
}

export default AdminSalesRevenuChart